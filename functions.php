...
function petrock_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'petrock_content_width', 640 );
}
...
function petrock_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'petrock' ),
			'id'            => 'sidebar-1',
...
function petrock_scripts() {
	...
	wp_enqueue_script( 'petrock-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
